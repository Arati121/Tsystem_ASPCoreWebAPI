    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          options.UseSqlServer(Configuration.GetSection("SqlConnection:ConnectionString").Value));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SampleWorkingWebAPI", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "SampleWorkingWebAPI v1"));
            }
